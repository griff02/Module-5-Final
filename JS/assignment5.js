...
{
    var count = 0;
    var displaytext = "<table><tr><th>Customer ID</th><th><th></th><th>Customer Name</th><th></th><th>Customer City</th></tr></table>";
    for (count = 0; count < result.GetAllCustomersResult.length; count++)
    {
    displaytext += "   " + result.GetAllCustomersResult[count].CustomerID + " , " + result.GetAllCustomersResult[count].CompanyName + " , " +result.GetAllCustomersResult[count].City+" , "+ "<br>";
    }
...
{
    var count = 0;
    var displaytext = "<table><tr><th>Product Name</th><th>Quantities Ordered</th></tr></table>";
    for (count = 0; count < result.getCustomerOrderHistoryResult.length; count++)
    {
    displaytext += result.getCustomerOrderHistoryResult[count].ProductName+ ", " + result.getCustomerOrderHistoryResult[count].Total+ "<br>";
    }
